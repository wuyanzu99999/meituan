                ...
                <table class="cart-list">
                    <tr v-for="(goods,index) in goodslist" :key="index">
                        ...
                        <td>
                            ...
                            {{goods.count}}
                            <input type="button" value="+" @click="add(index)" :disabled="goods.count<=0">
                        </td>
                        <td>
...
.address h2 input,.address p input{
    background-color: transparent;
    border: none;
    color: #cbcbcb;
    float: right;
